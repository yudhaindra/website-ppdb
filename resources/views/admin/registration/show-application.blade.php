...
<div class="container-fluid">
    ...
    <nav aria-label="breadcrumb" class="mb-4">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item"><a href="{{ route('registrations.show', $application->registration_id) }}">{{ $application->registration->name }}</a></li>
                ...
                <div class="card-body">
                    <table class="table table-borderless">
                        ...
                        <tr>
                            ...
                            <td>: {{ $application->birth_place }}, {{ $application->birth_date->translatedFormat('d F Y') }}</td>
                        </tr>
                        <tr>
                            <td>Agama</td>
                ...
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-3 mb-3">
                            <a href="{{ asset('storage/' . $application->birth_certificate_filepath) }}" class="btn btn-primary w-100" target="_blank">
                                <i class="fas fa-file-pdf mr-2"></i> Akta Kelahiran
                            </a>
                        </div>
                        <div class="col-md-3 mb-3">
                            <a href="{{ asset('storage/' . $application->family_card_filepath) }}" class="btn btn-primary w-100" target="_blank">
                                <i class="fas fa-file-pdf mr-2"></i> Kartu Keluarga
                            </a>
                        </div>
                        <div class="col-md-3 mb-3">
                            <a href="{{ asset('storage/' . $application->report_card_filepath) }}" class="btn btn-primary w-100" target="_blank">
                                <i class="fas fa-file-pdf mr-2"></i> Rapor
                            </a>
                        </div>
                        <div class="col-md-3 mb-3">
                            <a href="{{ asset('storage/' . $application->recent_photo_filepath) }}" class="btn btn-primary w-100" target="_blank">
                                <i class="fas fa-image mr-2"></i> Pas Foto
                            </a>
                        </div>
                        @if($application->achievement_certificate_filepath)
                        <div class="col-md-3 mb-3">
                            <a href="{{ asset('storage/' . $application->achievement_certificate_filepath) }}" class="btn btn-primary w-100" target="_blank">
                        ...
                        <div class="col-md-3 mb-3">
                            <a href="{{ asset('storage/' . $application->domicile_certificate_filepath) }}" class="btn btn-primary w-100" target="_blank">
